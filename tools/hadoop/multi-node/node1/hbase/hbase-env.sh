...
export JAVA_HOME=/usr/local/devtools/jdk7

# Extra Java CLASSPATH elements.  Optional.
# export HBASE_CLASSPATH=
#HBASE_CLASSPATH=/usr/local/data/tools/hadoop/etc/hadoop
...
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS $HBASE_JMX_BASE -Xmx6000m -Xms6000m -Xmn2250m -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=20"
